...
def send_booking_notification_email(booking_data):
    ...
    try:
        ...
        msg['Subject'] = "New Health Camp Registration - Fitnastic"
...
def create_booking_email_body(booking_data):
    ...
    <body>
        <div class="container">
            <div class="header">
                <h2>🎉 New Health Camp Registration</h2>
                <p>Fitnastic Health Camp</p>
            </div>
            ...
            <div class="footer">
                <p>This is an automated notification from Fitnastic Health Camp Registration System</p>
