...
DEFAULT_CONFIG = {
    ...
    'reference_api_enabled': False,
    'reference_metsights_api_key_male': '01993398a5aadb4a2798b6e98c2e08ee',
    'reference_metsights_api_key_female': '01993398a5aadb4a2798b6e98c2e08ee',
    'reference_engagement_id_male': '',
    'reference_engagement_id_female': '',
    'reference_api_trigger_options': [],  # List of reference options that trigger the API
    'database_name': 'bookings_bio_ai.db',
