# config.py - Configuration settings for the Firozpur camp booking system
...
ADMIN_PASSWORD = 'Str0ngP@ssw0rd16'  # Change this to your desired password
...
DEFAULT_CONFIG = {
    ...
    'database_name': 'bookings_camp_firozpur.db',
