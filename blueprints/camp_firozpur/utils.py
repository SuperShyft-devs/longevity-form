# utils.py - Utility functions for date and time operations for Firozpur camp
...
def validate_booking_data(form_data):
    ...
    try:
        ...
        doctor_consultation = form_data.get('doctor_consultation', 'Yes').strip()  # Default to Yes

        print(f"Debug: first_name='{first_name}', last_name='{last_name}', phone='{phone}', email='{email}', age_str='{age_str}', gender='{gender}', doctor_consultation='{doctor_consultation}'")

        # Validate required fields presence
        if not all([first_name, last_name, email, age_str, gender, phone]):
        ...
        # Validate doctor_consultation: must be Yes or No
        if doctor_consultation not in ['Yes', 'No']:
            print(f"Debug: Doctor consultation invalid: '{doctor_consultation}'")
            return False, 'Doctor consultation must be Yes or No', None
